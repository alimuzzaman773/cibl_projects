...
ALTER TABLE `apps_users_group` CHANGE `ccNoOfTxn` `ccNoOfTxn` INT(11) NOT NULL DEFAULT '0';
ALTER TABLE `apps_users_group_mc` CHANGE `ccNoOfTxn` `ccNoOfTxn` INT(11) NOT NULL DEFAULT '0';
