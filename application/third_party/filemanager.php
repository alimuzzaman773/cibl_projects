...
$auth_users = array(
    'admin' => '$2y$10$yEQGw5BAi8EM3FyUvr5Fuu.TxSyr//xKDB9tEJ7m/ecWvUR/Po6cS', //123456
...
// Configuration
//$cfg = new FM_Config();
$cfg = fm_object_to_array(json_decode($CONFIG));
...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <link href="<?= base_url().ASSETS_FOLDER?>filemanager/dropzone.min.css" rel="stylesheet">
    <div class="path">
    ...
    <script src="<?= base_url().ASSETS_FOLDER?>filemanager/dropzone.min.js"></script>
    <script>
...
<head>
    ...
    <?php if($favicon_path) { echo '<link rel="icon" href="'.fm_enc($favicon_path).'" type="image/png">'; } ?>
    <title><?php echo fm_enc(APP_TITLE) ?></title>
    <link rel="stylesheet" href="<?= base_url().ASSETS_FOLDER?>bootstrap-4.6/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?= base_url().ASSETS_FOLDER?>themes/font-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="<?= base_url().ASSETS_FOLDER?>filemanager/ekko-lightbox.css" />
    <?php if (FM_USE_HIGHLIGHTJS): ?>
    <link rel="stylesheet" href="<?= base_url().ASSETS_FOLDER?>filemanager/vs.min.css">
    <?php endif; ?>
    <style>
...
<script src="<?= base_url().ASSETS_FOLDER?>bootstrap-4.6/jquery.min.js"></script>
<script src="<?= base_url().ASSETS_FOLDER?>bootstrap-4.6/js/bootstrap.min.js"></script>
<script src="<?= base_url().ASSETS_FOLDER?>filemanager/jquery.dataTables.min.js"></script>
<script src="<?= base_url().ASSETS_FOLDER?>filemanager/ekko-lightbox.min.js"></script>
<?php if (FM_USE_HIGHLIGHTJS): ?>
    <script src="<?= base_url().ASSETS_FOLDER?>filemanager/highlight.min.js"></script>
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE):
        ...
        ?>
    <script src="<?= base_url().ASSETS_FOLDER?>filemanager/ace.js"></script>
    <script>
