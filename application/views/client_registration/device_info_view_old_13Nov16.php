...
-->
    ...
    <script id="rowTemplate" type="text/html">
        <td style="text-align:center"><button data-bind="click: $root.editDevice, visible: edit" class="btn btn-warning">Edit</button></td>
...
<table width="50" border="0" cellpadding="2">
    <tr>
        ...
        <td width="100"><button style="display: none;" id="addDevice" data-bind="click :$root.addDevice" class="btn btn-success">Add Device</button></td>
        <td width="100"><button style="display: none;" id="lock" data-bind="click :$root.lock" class="btn btn-success">Lock</button></td>
        <td width="100"><button style="display: none;" id="unlock" data-bind="click :$root.unlock" class="btn btn-success">Unlock</button></td>
        <td width="100"><button style="display: none;" id="active" data-bind="click :$root.active" class="btn btn-success">Active</button></td>
        <td width="100"><button style="display: none;" id="inactive" data-bind="click :$root.inactive" class="btn btn-success">Inactive</button></td>        
    </tr>
</table>
