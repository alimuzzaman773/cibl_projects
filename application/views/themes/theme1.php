...
<script src="<?php echo base_url(); ?>assets/themes/default/js/lib/sweet-alert.min.js"></script> 
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/themes/default/js/lib/sweet-alert.css">
...
<script type="text/javascript">
    $(document).ready(function(){        
        ...
        $(".ftitle").text(page_title);
        $(".ftitle").css({"fontSize": "25px"});            
    });
</script>
