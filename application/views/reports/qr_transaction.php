<h2 class="center">Transaction Report</h2>
<form name="myform" id="myform" method="get" target="_blank" action="<?= $base_url . 'ajax_report/qr_transaction/' ?>">
    <table class="table table-bordered table-condensed table-hover table-striped apps_transaction" cellpadding="0" cellspacing="1" border="0" style="width:100%">
        ...
        <tr>
            ...
            <td>
                <div class="col-md-3">
                    <select class="form-control input-sm" name="transaction_status">
        ...
        <tr>
            <td><b>Merchant Address</b></td>
            <td>
                <div class="col-md-3">
                    <select class="form-control input-sm" name="merchant_address">
                        <option value="">Show All</option>
                        <?php foreach ($merchantAddresses as $m) { ?>
                            <option value="<?= $m->merchantAddress?>"><?= $m->merchantAddress?></option>
                        <?php } ?>
                    </select>
        ...
        <tr>
            ...
            <td>
                <div class="col-sm-3 col-xs-12">
                    <input type="text" class="form-control input-sm" value="" name="transaction_id" id="transaction_id" />
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="col-sm-3 col-xs-12">
                    <input type="text" class="form-control input-sm" value="" name="eblSkyId" id="eblSkyId" />
                </div>
            </td>
        </tr>
        <tr>
...
<script type="text/javascript">
    ...
    var generateReport = function (dom)
    {
        ...
        $.ajax({
            url: '<?= $base_url . 'ajax_report/qr_transaction/' ?>',
            type: 'post',
            data: formData,
            dataType: 'json',
