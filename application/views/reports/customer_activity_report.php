<h2 class="center">Apps User Activity Report</h2>
<form name="myform" id="myform" method="get" target="_blank" action="<?=$base_url.'ajax_report/customer_activity_report/'?>">
...
<script type="text/javascript">
    ...
    var generateReport = function(dom)
    {
        ...
        $.ajax({
            url:'<?=$base_url.'ajax_report/customer_activity_report/'?>',
            type:'post',
            data:formData,
            dataType:'json',
