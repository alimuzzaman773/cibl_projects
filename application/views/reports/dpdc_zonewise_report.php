<h2 class="center">DPDC Zone Wise Report</h2>
<form name="myform" id="myform" method="get" target="_blank" action="<?= $base_url . 'ajax_report/dpdc_zonewise_report/' ?>">
    <table class="table table-bordered table-condensed table-hover table-striped apps_transaction" cellpadding="0" cellspacing="1" border="0" style="width:100%">
        ...
        <tr>
            ...
            <td>
                <div class="col-md-3">
                    <select class="form-control input-sm" name="transaction_status"required>
                        <option value="all">Show All</option>
                        <option value="n">Failed</option>
                        <option value="2">Success</option>
                        <option value="3">Success at Utility</option>
                        <option value="4">Failed at Utility</option>
                    </select>
                </div>
            </td>
        </tr>
...
<script type="text/javascript">
    ...
    var generateReport = function (dom)
    {
        ...
        $.ajax({
            url: '<?= $base_url . 'ajax_report/dpdc_zonewise_report/' ?>',
            type: 'post',
            data: formData,
            dataType: 'json',
