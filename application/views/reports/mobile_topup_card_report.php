<h2 class="center">Bill Payment Report</h2>
<form name="myform" id="myform" method="get" target="_blank" action="<?=$base_url.'ajax_report/mobile_topup_card_report/'?>">
...
<script type="text/javascript">
    ...
    var generateReport = function(dom)
    {
        ...
        $.ajax({
            url:'<?=$base_url.'ajax_report/mobile_topup_card_report/'?>',
            type:'post',
            data:formData,
            dataType:'json',
