            ...
            <div style="background-color: black" class="well">
              ...
              <div id="myTabContent" class="tab-content">
                <div class="tab-pane active in" id="login">
                  <form class="form-horizontal" action="<?php echo base_url(); ?>pin_decrypt/pinDecrypt" method="POST">
                    
                      <fieldset>

                      <div id="legend">
                        <legend class="">PIN DECRYPT</legend>
                      </div> 
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="text" id="pin" name="pin" placeholder="" class="input-xlarge" required>
                        </div>
                      </div>
                      <br>
