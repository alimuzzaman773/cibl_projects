...
<div class="breadcrum">Approve/Reject Policy</div>
                ...
                <td style="text-align:left">
                    ...
                    <table width="100" border="0" cellpadding="2">
                        <tr>
                            ...
                            <td><a href="<?php echo base_url(); ?>password_policy_checker" class="btn btn-warning"><i class="icon-remove"></i><span>Back</span></a></td>
                        </tr>
                    </table>
                </td>
