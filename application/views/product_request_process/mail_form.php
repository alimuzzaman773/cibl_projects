...
<div class="container" style="margin-top:50px">
    ...
    <form method="get" style="" id="mailForm" name="mailForm" action="<?php echo base_url(); ?>product_request_process/sendMail">
        ...
        <fieldset>
            ...
            <table border="0" cellpadding="5">
                ...
                <input hidden type="text" name="applyId" id="applyId" value="<?=$applyId?>" style="width: 700px">


                <tr>
                    <th align="left" scope="row">To</th>
                    <td><input type="text" id="toMail" name="to" value="<?=$to?>" style="width: 700px" required></td>
                </tr>
                 <tr>
     ...
     <a href="<?php echo base_url(); ?>product_request_process/getRequest?fromDate=<?=$fromDate?>&toDate=<?=$toDate?>" class="btn btn-success"><i class="icon-remove"></i><span> Back </span></a>
</div>
