...
<div class="container">
    <form method="post" style="" id="mailForm" name="mailForm" action="<?php echo base_url(); ?>product_request_process/sendMail">
        <table class="table table-condensed table-bordered table-striped">
            <input hidden type="text" name="applyId" id="applyId" value="<?= $applyId ?>">
            <tr>
                <th align="left" scope="row">To</th>
                <td><input type="text" class="form-control input-sm" id="toMail" name="to" value="<?= $to ?>" required></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" class="form-control input-sm" class="form-control input-sm" id="bccMail" name="bcc" value=""></td>
            </tr>
            ...
            <input type="text" class="form-control input-sm" id="body" name="body" style="display:none" value="<?= $body ?>">
            </tr>
            <tr>
                <th align="left" scope="row">Instruction<br>(Optional)</th>    
                <td><textarea class="form-control input-sm" rows="8" id="bodyInstruction" name="bodyInstruction"></textarea></td>
            </tr>
            <tr>
    ...
    <a href="<?php echo base_url(); ?>product_request_process/getRequest" class="btn btn-success"><i class="icon-remove"></i><span> Back </span></a>
</div>
