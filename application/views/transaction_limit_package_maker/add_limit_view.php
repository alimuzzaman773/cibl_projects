    ...
    <div class="row">
        ...
        <div class="col-sm-4 col-xs-12 col-md-4">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="groupDescription" id="groupDescription" value="<?= $groupDescription ?>" readonly />       
            </div>
        </div>
        <div class="col-sm-4 col-xs-12 col-md-4">
            <div class="form-group">
                <label>Global Limit</label>
                <input class="form-control" type="number" min="0" name="globalLimit" id="globalLimit" value=""/>       
            </div>
        </div>
    </div>   
</div>
