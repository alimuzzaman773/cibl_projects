    ...
    <div class="row">
        <div class="col-sm-4 col-xs-12 col-md-4">
            <div class="form-group">
                ...
                <input class="textbox" type="text" name="groupName" id="groupName" value="<?= $userGroupName ?>" readonly>        
            </div>
        </div>
        <div class="col-sm-4 col-xs-12 col-md-4">
            <div class="form-group">
                <label>Group Description</label>
                <input class="form-control" type="text" name="groupDescription" id="groupDescription" value="<?= $userGroupDescription ?>" readonly />       
            </div>
        </div>
        <div class="col-sm-4 col-xs-12 col-md-4">
            <div class="form-group">
                <label>Global Limit</label>
                <input class="form-control" type="number" min="0" name="globalLimit" id="globalLimit" value="<?= $globalLimit ?>"/>       
            </div>
        </div>
    </div>   
</div>
