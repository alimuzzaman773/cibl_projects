            ...
            <div style="background-color:" class="well">
              ...
              <div id="myTabContent" class="tab-content">
                <div class="tab-pane active in" id="login">
                  ...
                  <form class="form-horizontal" action="<?php echo base_url(); ?>admin_login/retriveForgotPassword" method="POST">
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="text" id="userEmail" name="userEmail" placeholder="" class="input-xlarge" required>
                        </div>
                      </div>
                      <br>
                      ...
                      <tr>
                          ...
                          <td>
                              ...
                              <a href="<?php echo base_url(); ?>admin_login/index" class="btn btn-success"><i class="icon-remove"></i><span> Back </span></a>
                          </td>
                      </tr>
