...
var PinModule = angular.module('PinModule', ['angularUtils.directives.dirPagination']);

PinModule.controller("PinController", ["$scope", "$http", function ($scope, $http) {
        ...
        $scope.getResultsPage = function (pageNumber) {
            ...
            $http({
                method: "get",
                url: app.baseUrl + "pin_generation/get_pin_list",
                params: $params
...
app.addModules("PinModule", "PinModule");